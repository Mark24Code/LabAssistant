...
class Pong(Frame):
    def createWidgets(self):
        ## 画布
        self.draw = Canvas(self,width='6i', height='6i', bg='white')
        ## 游标(控制小球移动速度，范围：[-100, 100])
        self.speed = Scale(self, orient=HORIZONTAL, label="小球速度",
                           from_=-100, to=100)
...
if __name__== '__main__':
    game = Pong()
    MyThread(game.after,(10,game.moveBall()))
    MyThread(game.after,(10,game.move_second_ball()))
    MyThread(game.after,(10,game.move_three_ball()))
    MyThread(game.after,(10,game.move_four_ball()))
    MyThread(game.after,(10,game.move_five_ball()))
    game.mainloop()