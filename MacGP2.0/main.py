...
class Window(Tkinter.Tk):
    ...
    def quitwin(self):
        self.destroy()
    def wm_geo(self,width=580,height=360):
...
def Calc():
    MyThread(os.system,('python Script/Calculator.py',))

#模拟实验部分
def StarModel():
    MyThread(os.system,('python %s/Script/StarModel.py'%WORKPATH,))
    #os.system()
def CrashBall():
    #os.system('python %s/Script/MultiBall.py'%WORKPATH)
    MyThread(os.system,('python %s/Script/MultiBall.py'%WORKPATH,))

def Timer():
    #os.system('python %s/Script/Timer.py'%WORKPATH)
    MyThread(os.system,('python %s/Script/Timer.py'%WORKPATH,))

def Chat():
    #os.system('python %s/Script/Chat.py'%WORKPATH)
    MyThread(os.system,('python %s/Script/Chat.py'%WORKPATH,))
